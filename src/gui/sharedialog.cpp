    ...
    , _baseUrl(baseUrl)
{
    ...
    auto job = new PropfindJob(accountState->account(), _baseUrl, _sharePath, PropfindJob::Depth::Zero, this);
...
void ShareDialog::slotPropfindReceived(const QString &, const QMap<QString, QString> &result)
{
